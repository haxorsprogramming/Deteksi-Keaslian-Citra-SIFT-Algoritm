<!DOCTYPE html>
 ...
 <body style="font-family: 'Nunito Sans';">
       ...
       <div class="main-content" id="divMain">
         <section class="section">
           <div class="section-header">
             <h1 id="capUtama"> Aplikasi Deteksi Keaslian Citra - [[ titleApps ]] </h1>
           </div>
   ...
   <script src="../ladun/dasbor/stisla/js/jquery.nicescroll.min.js"></script>
   <script src="../ladun/dasbor/stisla/js/moment.min.js"></script>
   ...
   <script>
     const server = "http://localhost/Aplikasi-Skirpsi-Putri/";
   </script>
   <script src="../ladun/dasbor/index.js"></script>
 </body>
 </html>